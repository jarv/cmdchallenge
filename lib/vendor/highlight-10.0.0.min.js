...
*/
!function (e, n) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define(n) : (e = e || self).hljs = n();
}(void 0, function () {
  "use strict";
  ...
  function e(n) {
    ...
    return Object.getOwnPropertyNames(n).forEach(function (r) {
      !n.hasOwnProperty(r) || null === n[r] || "object" != _typeof(n[r]) && "function" != typeof n[r] || t && ("caller" === r || "callee" === r || "arguments" === r) || Object.isFrozen(n[r]) || e(n[r]);
    }), n;
  }
  ...
  var l = /*#__PURE__*/function () {
    ...
    _createClass(l, [{
      ...
      value: function _collapse(e) {
        e.children && (e.children.every(function (e) {
          return "string" == typeof e;
        }) ? (e.text = e.children.join(""), delete e.children) : e.children.forEach(function (e) {
  ...
  return function (n) {
    ...
    function p(e, n, r, i) {
      ...
      !function (e) {
        ...
        !function r(s, o) {
          ...
          }(s.keywords, e.case_insensitive)), s.lexemesRe = n(s.lexemes || /\w+/, !0), o && (s.beginKeywords && (s.begin = "\\b(" + s.beginKeywords.split(" ").join("|") + ")(?=\\b|\\s)", s.__onBegin = i), s.begin || (s.begin = /\B|\b/), s.beginRe = n(s.begin), s.endSameAsBegin && (s.end = s.begin), s.end || s.endsWithParent || (s.end = /\B|\b/), s.end && (s.endRe = n(s.end)), s.terminator_end = u(s.end) || "", s.endsWithParent && o.terminator_end && (s.terminator_end += (s.end ? "|" : "") + o.terminator_end)), s.illegal && (s.illegalRe = n(s.illegal)), null == s.relevance && (s.relevance = 1), s.contains || (s.contains = []), s.contains = (_ref3 = []).concat.apply(_ref3, _toConsumableArray(s.contains.map(function (e) {
            return function (e) {
      ...
      try {
        ...
        for (_.matcher.considerAll(); A ? A = !1 : (_.matcher.lastIndex = L, _.matcher.considerAll()), y = _.matcher.exec(s);) {
    ...
    Object.assign(n, {
      ...
      registerLanguage: function registerLanguage(e, t) {
        var r;
      ...
      autoDetection: k,
      inherit: w,
      addPlugin: function addPlugin(e, n) {
        s.push(e);
      }
